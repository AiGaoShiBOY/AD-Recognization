...
def print_progress(epoch=None, n_epoch=None,
...
def print_epoch_progress(epoch, num_epochs, train_loss, val_loss, time_duration, train_metric,
                         val_metric):
    ...
    log_str = "Epoch:{}/{}|".format(epoch, num_epochs)
